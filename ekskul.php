                        ...
                        <div class="card-body">
                            <div class="table-responsive p-2">
                                ...
                                <table class="table table-bordered" id="table_id">
                                    ...
                                    <tbody>
                                        <?php $i = 1; ?>
                                        <?php foreach ($ekskul as $ds): ?>
                                            <tr>
                                                <td class="text-center align-middle"><?= $i++; ?>.</td>
                                                <td class="align-middle text-start"><?= $ds['nama_ekskul']; ?></td>
                                                <td class="align-middle text-start"><?= date("d-m-Y, H:i", strtotime($ds['dibuat_pada'])); ?></td>
                                                <td class="text-center align-middle">
                                                    <a href="ubah_ekskul.php?id_ekskul=<?= $ds['id_ekskul']; ?>" class="m-1 btn btn-success"><i class="fas fa-fw fa-edit"></i> Ubah</a>
                                                    <a href="hapus_ekskul.php?id_ekskul=<?= $ds['id_ekskul']; ?>" data-nama="<?= $ds['nama_ekskul']; ?>" class="m-1 btn btn-danger btn-delete"><i class="fas fa-fw fa-trash"></i> Hapus</a>
                                                </td>
                                            </tr>
                                        <?php endforeach ?>
                                    </tbody>
